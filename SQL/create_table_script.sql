...
create table SUBJECT ( subject_id integer(10), subject_name varchar(30), teacher_id integer(6));

CREATE TABLE HOMEROOM ( HOMEROOM_ID integer(6), HOMEROOM_NAME varchar(30), TEACHER_ID integer(6),
constraint teacherID_fk foreign key(teacher_id) references teacher(teacher_id));

CREATE TABLE ASSIGNMENT (ASSIGNMENT_ID integer(6), ASSIGNEMENT_NAME varchar(30), URL varchar(30), SUBJECT_ID integer(10),
...
CREATE TABLE STUDENT(STUDENT_ID integer(6), FNAME varchar(20), LNAME varchar(20), BIRTHDATE DATE, HOMEROOM_ID integer(6),
CONSTRAINT STUDENT_PK PRIMARY KEY(STUDENT_ID), CONSTRAINT ROOM_fk foreign key(homeroom_id) REFERENCES homeroom(homeroom_id));


CREATE TABLE HOMEWORK (HOMEWORK_ID integer(6), URL varchar(30), FINAL_GRADE VARCHAR(2), STUDENT_ID integer(6), ASSIGNMENT_ID integer(6),
...
CREATE TABLE TAKEN_BY (STUDENT_ID integer(6), SUBJECT_ID integer(6), FINAL_GRADE VARCHAR(2),
